...
# %% auto 0
__all__ = ['valid_dtypes', 'build_DSAIR', 'payoffs_sr', 'payoffs_sr_pfo_extension', 'payoffs_lr', 'punished_and_sanctioned_payoffs', 'payoffs_lr_peer_punishment', 'payoffs_lr_peer_reward', 'payoffs_lr_voluntary', 'payoffs_encanacao_2016']
